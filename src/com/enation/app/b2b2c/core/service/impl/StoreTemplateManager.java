...
public class StoreTemplateManager extends BaseSupport implements IStoreTemplateManager {
	...
	public Integer add(StoreTemlplate storeTemlplate) {
		...
		return this.baseDaoSupport.getLastId("es_store_template");
	}
	...
	@Override
	public Integer getStoreTemlpateByName(String name) {
		int i= this.baseDaoSupport.queryForInt("select count(0) from es_store_template where name=?", name);
		return i;
	}
