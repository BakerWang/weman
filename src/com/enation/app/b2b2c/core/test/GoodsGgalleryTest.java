...
//					List<GoodsGallery> list=goodsGalleryManager.list(Integer.parseInt(goods.get("goods_id").toString()));
...
//			}
	...
	public void proessPhoto(String[] picnames, Map goods, String image_default) {
		Integer store_id=Integer.parseInt(goods.get("store_id").toString());
		if (picnames == null) {
			return;
		}		
