...
public class LiveUtils {
	...
	public static void main(String[] args) {
		try {
			...
			//System.out.println(getStream("z1.test-02.lsdf001").toJsonString());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	// 保存直播数据
	public static String saveLive(String streamName) throws Exception {
		String saveAsFormat = "mp4"; // required
		String saveAsName = "yimei" + new Date().getTime() + "." + saveAsFormat; // required
