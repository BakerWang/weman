...
<div style="background-color: white; padding: 15px 0 8px 10px;margin:0px;position: relative;">
	<form id="addForm"  enctype="multipart/form-data"  method="post">
		<table style="width:98%;">
			<tr height="38px"><td class="spanFront">banner标题 : </td><td><input class="inputFront" name="phoneBanner.title" /></td></tr>
...
<script>
	...
	function submitForm() {
			$.Loading.show("正在添加......");
			var options = {
				url : "/b2b2cbak/apiAdmin/AdminBannerAction_saveBanner.do",
				type : "POST",
				dataType : 'json',
